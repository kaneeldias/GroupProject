<div class="row col-md-12" id="dashboard">
    <div class="column col-md-3 dashboard_links" style="padding:0px;">
        <a href="<?=base_url("time-table/select/student")?>"><div class="dashboard_link">View time table</div></a>
        <a href="<?=base_url("booking")?>"><div class="dashboard_link">Hall booking</div></a>
