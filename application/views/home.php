...
<header>
    <div class="container">
        ...
        <div class ="row">
            ...
            <div class="col-md-6">
                <h1 class="wow fadeIn" data-wow-offset="0" data-wow-delay="0.9s"><span>UCSC </span>Academic Support System</h1>
            </div>
        </div>
    </div>
</header>
...
<section id="portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span><div id="particles-js"></div>Venue</span> We have</h2>
            </div>
